...
namespace LoginBlazor.Controllers
{
    public class LoginController : Controller
    {
        [HttpPost("/account/login")]
        public async Task<IActionResult> Login(Usuarios credentials)
        {
            ...
            try
            {
                using (DirectoryEntry entry = new DirectoryEntry(path, credentials.Username, credentials.Contraseña))
                {
